...
- Frontend: `artifacts/engram/src/pages/` (Environment, Inquiry, Chat, Commons, Simulations, Terminal, etc.); routes in `App.tsx`, nav in `components/layout.tsx`; shadcn/ui in `components/ui/`; wouter router; Tailwind v4 cyberpunk cyan theme.
